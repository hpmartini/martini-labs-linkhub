      ...
      <div className="relative z-10 w-full max-w-xl flex flex-col items-center gap-8">
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full justify-center mt-4">
          <button 
            ...
            className="flex-1 group relative px-6 py-4 bg-black/70 rounded-xl font-orbitron text-cyan-400 border border-cyan-500/50 hover:border-cyan-400 transition-all duration-300 shadow-[0_0_15px_rgba(0,255,255,0.1)] hover:shadow-[0_0_25px_rgba(0,255,255,0.3)]"
          >
          ...
          <button 
            ...
            className="flex-1 group relative px-6 py-4 bg-black/70 rounded-xl font-orbitron text-pink-400 border border-pink-500/50 hover:border-pink-400 transition-all duration-300 shadow-[0_0_15px_rgba(236,72,153,0.1)] hover:shadow-[0_0_25px_rgba(236,72,153,0.3)]"
          >
            <span className="relative z-10 flex items-center justify-center gap-2">
